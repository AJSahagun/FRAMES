      ...
      <div className="flex h-auto">
        ...
        <div className="flex-2 w-1/3 mt-10">
          <div className="flex justify-center items-center" >
            ...
            <div className="relative w-2/3 h-10 py-7 pl-9 pr-9 mt-4 ml-6 align-middle  flex flex-row justify-center items-center bg-red-700 text-white text-s">
            Foster Wheeler - Alangilan
            </div>
            <Image className="absolute mr-44"
